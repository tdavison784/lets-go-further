...
// EmailRX  a regular expression for sanity checking the format of email addresses
var (
...
// AddError adds an error message to the map (so long as no entry already exists for given key)
...
// PermittedValue generic function which returns true if a specific value in a list of permitted values
